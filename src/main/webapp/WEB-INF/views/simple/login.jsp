...
<div class="wrap">
    <div class="container">
       <form class="form-signin" role="form" action="${path}/simple/checkLogin" method="post">
	      ...
	      <input type="text" class="form-control input-lg" id="userName" name="userName"value="huyang" >
	      <input type="password" class="form-control input-lg" id="passWord" name="passWord" value="000000">
	      <div align="center">
