...
<jsp:include page="head.jsp"></jsp:include>
	...
	<div class="container">
			...
			%>
			<form action="${path}/simple/submit" method="post" role="form" class="leaveform">
				...
				%>
				<form action="${path}/simple/submit" method="post" role="form" class="form-horizontal leaveform">
				<h2 class="form-signin-heading text-center"><%=task.getName()%></h2>
					<input type="hidden" name="taskId" value="<%=taskId%>">
