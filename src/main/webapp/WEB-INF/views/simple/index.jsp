                ...
                <form action="${path}/simple/deploy" method="post" enctype="multipart/form-data" class="form-inline">
                    <div class="fileinput fileinput-new" data-provides="fileinput">
                        <div class="input-group">
                            <div class="form-control span3" data-trigger="fileinput"><i
                    ...
                    <c:forEach var="pd" items="${pdList}">
                        <tr>
                            ...
                            <td>
                                ...
                                &nbsp;|&nbsp;
                                <a href="${path}/simple/viewprocessDef.do?processDefId=${pd.id}"
                                   target="_blank">查看流程定义</a>
                                &nbsp;|&nbsp;
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <c:forEach var="task" items="${taskList}">
                        <tr>
                            ...
                            <td><a href="${path}/simple/view.do?executionId=${task.executionId}" target="_blank">流程图</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
