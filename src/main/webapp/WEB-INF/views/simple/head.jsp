...
<html lang="zh-cn">
  <head>
	...
	<link href="${path}/static/bootstrap-file/css/bootstrap.min.css" rel="stylesheet">
	<link href="${path}/static/bootstrap-select/bootstrap-select.min.css" rel="stylesheet">
	<link href="${path}/static/bootstrap-file/css/bootstrap-theme.min.css" rel="stylesheet">
	<link href="${path}/static/prettify/prettify.css" rel="stylesheet">
    ...
    <div class="navbar navbar-fixed-top navbar-default" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="${path }/simple/index">基于Activiti5.13和Bootstrap3.0.3的请假流程</a>
        </div>
